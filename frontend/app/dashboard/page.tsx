...
/>
      ...
      <div className="rounded-2xl border border-[#E2E8F0] bg-white p-5 shadow-sm">
        ...
        {/* ✅ optional: "Durchschnittsdauer" kannst du hier unten reinpacken,
            aber du hattest es oben als 4. Card; wir haben es bewusst rausgelassen,
            weil du nur 3 wichtige Stats wolltest + Antwortquote. */}
